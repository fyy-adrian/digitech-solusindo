...
export default function Contact(){
    return(
    <div className="px-12 lg:px-44 flex  flex-col justify-between items-center pb-20 bg-[#E7FADE]">
        <Title header="contact us" desc="" />
        <div className="flex flex-col-reverse gap-10 lg:gap-20 lg:flex-row justify-between items-center">
            <form className="w-full max-w-sm">
                ...
                <div className="flex justify-items-center items-center mb-6 border-2 p-[.1px] rounded-xl border-[#366353]">
                    <textarea id="comment" rows="4" className="w-full p-3 rounded-xl border-[#366353] text-sm bg-transparent focus:ring-0 text-slate-800 placeholder:text-slate-500" placeholder="Write a comment..." required ></textarea>
                </div>
                <Button>
                    Contact us
                </Button>
